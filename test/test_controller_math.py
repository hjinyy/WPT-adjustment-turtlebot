...
def test_alignment_error_and_threshold():
    obs = TagObservation(tag_id=111, center_x=326, center_y=216, angle_deg=1.0)
...
def test_pair_alignment_error_uses_midpoint_and_pair_angle():
    west = TagObservation(tag_id=113, center_x=300, center_y=220, angle_deg=5.0, camera_name="left_bottom")
    east = TagObservation(tag_id=114, center_x=340, center_y=220, angle_deg=-3.0, camera_name="left_bottom")
...
def test_pair_alignment_angle_error():
    north = TagObservation(tag_id=111, center_x=320, center_y=200, angle_deg=0.0)
    south = TagObservation(tag_id=112, center_x=320, center_y=240, angle_deg=0.0)
...
def test_velocity_clamping_and_deadband():
    err = compute_alignment_error(
        TagObservation(tag_id=111, center_x=400, center_y=100, angle_deg=10),
